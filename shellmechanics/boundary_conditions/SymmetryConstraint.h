...
public:
  ...
  SymmetryConstraint(Args const &...args)
    : ConstraintBase("ShellSymmetryConstraint")
    , _residual(args...)
    , _jacobian(args...)
  {}
...
private:
  ...
  public:
    ...
    template<typename ...Args>
    Residual(Args &&...args)
      : base_t("ShellSymmetryConstraint_Residual")
    {}
  ...
  public:
    ...
    Jacobian(double uv, size_t dir, NormalSourceBase const &normal)
      : base_t("ShellSymmetryConstraint_Jacobian")
