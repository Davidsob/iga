...
class DisplacementSymmetryConstraint 
...
public:
  ...
  DisplacementSymmetryConstraint(Args const &...args)
    : ConstraintBase("ShellDisplacementSymmetryConstraint")
    , _residual(args...)
    , _jacobian(args...)
  {}

  ~DisplacementSymmetryConstraint() = default;
...
private:
  ...
  public:
    ...
    template<typename ...Args>
    Residual(Args &&...args)
      : base_t("ShellDisplacementSymmetryConstraint_Residual")
    {}
  ...
  public:
    ...
    Jacobian(double uv, size_t dir, NormalSourceBase const &normal)
      : base_t("ShellDisplacementSymmetryConstraint_Jacobian")
    ...
    value_t const eval(Index const &i) const
    {
      ...
      value_t const nu{dot(t2,uid(shape))};
